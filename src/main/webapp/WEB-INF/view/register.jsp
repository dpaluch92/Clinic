            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row"> 
                        ...
                        <div class="col-sm-6">
                            <h1 style="margin-left: 15%;">Zadbaj o swoje serce pacjencie.</h1>
                            <br />
                            <img style="margin-left: 15%;" src="http://portalzdrowiadziecka.pl/wp-content/uploads/2016/08/serce-dziecka-.jpg" />
                        </div>
                    </div>
                </div>
            </div>
